...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Computer & Networking Hardware Course</title>
        <meta
          name="description"
          content="Learn to assemble, maintain, troubleshoot, and manage computers and basic networks with live practice sessions. ETU Academy Computer & Networking Hardware Course."
        />
      ...
      <main className="bg-gray-50 text-gray-900 font-sans">
        ...
        <header className="relative bg-gradient-to-r from-indigo-600 to-cyan-500 text-white">
          <div className="max-w-7xl mx-auto py-24 px-6 text-center">
            ...
            <p className="mt-4 text-xl md:text-2xl opacity-90">
              Hands-on IT Skills with Live Troubleshooting Practice
            </p>
            <p className="mt-2 text-lg md:text-xl opacity-80">
              Offline + Live Practice | Duration: 2–3 Months | Beginner to Intermediate
            </p>
          </div>
        ...
        <section className="relative py-24 px-6 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-12 text-center max-w-3xl mx-auto">
              Equip learners with hands-on skills to assemble, maintain, troubleshoot, and manage computer systems and basic networks. Ideal for beginners, students, and aspiring IT technicians.
            </p>
          </div>
        </section>
        ...
        <section className="relative py-24 px-6 bg-gradient-to-b from-white to-gray-50 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8">
              {[
                "Module 1: Introduction to Computer Hardware — Basics of systems, Motherboard, CPU, RAM, SMPS, Input/output devices, Storage types (HDD, SSD, NVMe)",
                "Module 2: PC Assembling & Disassembling — Identifying components, System building, BIOS/UEFI setup, Installing OS (Windows/Linux)",
                "Module 3: Troubleshooting & Diagnostics — Common hardware issues, Diagnostic tools (POST, beep codes), Maintenance, Upgrading components",
                "Module 4: Basic Networking & Internet Setup — LAN setup & IP configuration, Switches, routers, cabling, Wi-Fi setup, Internet sharing, firewall basics",
                "Module 5: Live Troubleshooting Lab — Real-world issue simulation, Hardware repair, Virus removal & system recovery, Customer service skills",
                "Module 6: Power Supply & Backup Systems — SMPS functioning, UPS types & configuration, Electrical safety, Surge protection",
              ].map((module, idx) => (
                <div
                  key={idx}
        ...
        <section className="py-20 px-6 bg-white">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              "Beginners interested in IT support",
              "School/college students",
              "Small business owners",
              "Hardware shop assistants & aspiring technicians",
            ].map((item, idx) => (
              <div
                key={idx}
        ...
        <section className="py-20 px-6 bg-gradient-to-b from-gray-100 to-gray-50">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              { name: "Screwdrivers & Thermal Paste", img: "/tools.png" },
              { name: "Spare CPUs, RAM, HDDs, Routers", img: "/components.png" },
              { name: "Diagnostic Software & Free Tools", img: "/software.png" },
            ].map((tool, idx) => (
              <div
                key={idx}
        ...
        <section className="py-20 px-6 bg-gradient-to-r from-indigo-600 to-cyan-500 text-white text-center">
          ...
          <p className="text-lg md:text-xl mb-8 max-w-3xl mx-auto leading-relaxed">
            ETU Academy Completion Certificate with Practical Hours Mentioned <br />
            Hands-on experience and practical lab evaluation included
          </p>

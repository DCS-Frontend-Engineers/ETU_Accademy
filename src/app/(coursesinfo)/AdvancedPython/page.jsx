  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Take your Python skills to the next level with real-world problem solving, advanced concepts, and industry use cases."
        />
      ...
      <main className="bg-gray-50 text-gray-900 font-sans">
        ...
        <header className="relative bg-gradient-to-r from-indigo-600 to-cyan-500 text-white">
          <div className="max-w-7xl mx-auto py-24 px-6 text-center">
            ...
            <p className="mt-2 text-lg md:text-xl opacity-80">
              Duration: 6–8 Weeks | Weekday & Weekend Batches
            </p>
          </div>
        ...
        <section className="py-20 px-6 bg-gradient-to-b from-gray-100 to-gray-50">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              { name: "Jupyter Notebook", img: "/CoursesImages/JupyterNotebook.png" },
              { name: "VS Code", img: "/CoursesImages/VSCode.png" },
              { name: "SQLite / PostgreSQL", img: "/CoursesImages/SQLitePostgreSQL.png" },
              { name: "Requests / APIs", img: "/CoursesImages/RequestsAPIs.png" },
              { name: "pytest / unittest", img: "/CoursesImages/pytestunittest.png" },
            ].map((tool, idx) => (
              <div
                key={idx}
        ...
        <section className="py-20 px-6 bg-gradient-to-r from-indigo-600 to-cyan-500 text-white text-center">
          ...
          <p className="text-lg md:text-xl mb-8 max-w-3xl mx-auto leading-relaxed">
            Instructor-led sessions <br />
            Live coding exercises <br />
            Code review and Git workflows <br />
            Certification of completion <br />
            Offline + Online modes available <br />
            Duration: 6–8 Weeks | Weekday & Weekend Batches
          </p>
